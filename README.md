# lms-course-attribute-editor
This tool allows administrators to view the identity attributes (including the SIS IDs) of any Canvas course and to edit the attributes of non-SIS courses and sections.
...
Insert a record into the `LTI_13_AUTHZ` table with your tool's registration_id (`lms_lti_course_attribute_editor`), along with the client_id
...
<tr><td>Initiate login URL</td><td>http://localhost:8080/lti/login_initiation/lms_lti_course_attribute_editor</td></tr>
